...
class TwitterFBLoginActivity : AppCompatActivity(), OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_twitter_fblogin)
        ...
        mAuth?.signInWithCredential(credential)
                ?.addOnCompleteListener(this) { task ->
                    if (task.isSuccessful) {
                        ...
                        Toast.makeText(this@TwitterFBLoginActivity, "Authentication failed.",
    ...
    private fun updateUI(user: FirebaseUser?) {
        //TODO: hideProgressDialog()
        if (user != null) {
            mStatusTextView?.setText(getString(R.string.twitter_status_fmt, user.displayName))
            ...
            findViewById<Button>(R.id.button_twitter_signout).setVisibility(View.VISIBLE)
        } else {
            mStatusTextView?.setText(R.string.signed_out)
            mDetailTextView?.setText(null)

            findViewById<Button>(R.id.button_twitter_login).setVisibility(View.VISIBLE)
            findViewById<Button>(R.id.button_twitter_signout).setVisibility(View.GONE)
        }
    }
